const constCareersBody = [
  ...
  },
  {
    ...
    description:
      "I have developed automated processes for transforming large datasets extracted from system applications using SQL, R Studio, and Python libraries and encrypted it in a secure manner, and then analyzed it to identify anomalies and exceptions for endorsement to auditors for further continuous auditing and investigation.",
  },
  {
...
export default constCareersBody;
